...
export default function ExportPage() {
  ...
  return (
    <div className="page-container">
      ...
      <div className="export-cards-grid" style={{ display: "grid", gridTemplateColumns: logCardProps ? "1fr 1fr 1fr" : "1fr 1fr", gap: 16, marginBottom: 16 }}>
        <ExportCard
          icon="📊"
          title="Balanced Dataset"
          desc={`The full balanced dataset as a CSV — all ${run.total_after?.toLocaleString() ?? ""} rows after applying ${run.method.toUpperCase()}.`}
